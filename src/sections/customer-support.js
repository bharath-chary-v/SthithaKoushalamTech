...
const CustomerSupport = () => {
  return (
    <Box as="section" sx={styles.customerSupport} id="services">
      <Container>
        <Grid sx={styles.row}>
          <Box sx={styles.col}>
            <Box sx={styles.content}>
              <Heading as="h3">
                 Customer Support to ensure what you like to expect
              </Heading>
              <Text as="p">
              Our Customer Support team is committed to providing excellent service. Our team of experienced professionals is available to help you right away and make sure that your problems are solved successfully. Clear communication and our continuous dedication to your pleasure are things you can rely on.
              </Text>
              <Text as="p" sx={styles.specialText}>
              Expect nothing less than the best possible service with a constant eye on your pleasure.
              </Text>
