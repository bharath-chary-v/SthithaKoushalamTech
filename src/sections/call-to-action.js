    ...
    <section id="techstack" style={{ padding: '80px 0', background: '#ffffff', borderTop: '1px solid #f1f5f9' }}>
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 24px' }}>
        <div style={{ textAlign: 'center', marginBottom: 48 }}>
          ...
          <div style={{ width: 40, height: 2, background: 'linear-gradient(90deg, #8D448B, #6366f1)', margin: '0 auto' }} />
        </div>
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: 10, justifyContent: 'center' }}>
          {TECH.map((t, i) => (
            <div
              key={i}
              style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '8px 16px', borderRadius: 100, border: '1.5px solid #f1f5f9', background: t.bg, cursor: 'default', transition: 'all 0.2s' }}
