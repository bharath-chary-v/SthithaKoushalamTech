...
const SERVICES = [
  {
    ...
    gradient: 'linear-gradient(135deg, #8D448B 0%, #a855f7 100%)',
    light: 'rgba(141,68,139,0.08)',
  ...
  },
  {
    ...
    gradient: 'linear-gradient(135deg, #ec4899 0%, #8D448B 100%)',
      ...
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 24px' }}>
        ...
        <div style={{ textAlign: 'center', maxWidth: 600, margin: '0 auto 64px' }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '6px 16px', borderRadius: 100, border: '1px solid rgba(141,68,139,0.25)', background: 'rgba(141,68,139,0.06)', marginBottom: 20 }}>
            <span style={{ fontSize: 11, fontWeight: 700, letterSpacing: '0.12em', textTransform: 'uppercase', color: '#8D448B' }}>What We Build</span>
          </div>
          <h2 style={{ fontSize: 'clamp(32px, 5vw, 52px)', fontWeight: 900, color: '#0a0a14', letterSpacing: '-0.03em', lineHeight: 1.1, margin: '0 0 16px' }}>
            Services built for{' '}
            <span style={{ background: 'linear-gradient(135deg, #8D448B 0%, #6366f1 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>scale</span>
          </h2>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gridTemplateRows: 'auto', gap: 16 }} className="bento-grid">
          {SERVICES.map((s, i) => (
            <div
              ...
              onMouseEnter={e => {
                e.currentTarget.style.borderColor = 'rgba(141,68,139,0.3)';
                e.currentTarget.style.boxShadow = '0 8px 40px rgba(141,68,139,0.1)';
