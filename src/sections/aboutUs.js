...
const AboutUs = () => {
  return (
    <Box sx={styles.boostAgencies} id="aboutUs">
      <Container>
        <Box sx={styles.row}>
          <Flex sx={styles.col}>
            <Box sx={styles.content}>
              <Box sx={styles.titleBox}>
                ...
                <Text as="p">
                We are a startup aiming for global growth in the perspectives of enlightening India. 
                </Text>
              </Box>
              <Box as="ul" sx={styles.list}>
                ...
                <Text as="li">
                  <IoIosCheckmarkCircle />
                  <span>Age, gender, community, colour doesn`t matter here.</span>
                </Text>
                <Text as="li">
                  <IoIosCheckmarkCircle />
                ...
                <Text as="li">
                  <IoIosCheckmarkCircle />
                  we believe in culture followed by work culture.
                </Text>
                <Text as="li">
                  <IoIosCheckmarkCircle />
